 ...
 * @author lstephen
 */
public class Esl implements Weightings {
  ...
  private static final Table TABLE =
      Table.builder()
          ...
          .add(Role.MF, Tactic.NORMAL, Weighting.create(25, 100, 25))
          ...
          .add(Role.DM, Tactic.DEFENSIVE, Weighting.create(110, 65, 0))
