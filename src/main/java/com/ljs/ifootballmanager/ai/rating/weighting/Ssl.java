  ...
  private static final Table TABLE =
      Table.builder()
          ...
          .bonus(
              Role.MF,
              Tactic.NORMAL,
              Weighting.create(25, 0, 25),
              Tactic.EUROPEAN,
              Tactic.ATTACKING)
          .bonus(
              Role.FW, Tactic.NORMAL, Weighting.create(0, 25, 0), Tactic.EUROPEAN, Tactic.ATTACKING)
          .bonus(
              Role.AM,
              Tactic.NORMAL,
              Weighting.create(0, 13, 23),
              Tactic.EUROPEAN,
              Tactic.ATTACKING)
          .bonus(
              Role.DM, Tactic.NORMAL, Weighting.create(23, 0, 0), Tactic.EUROPEAN, Tactic.ATTACKING)
          ...
          .bonus(
              Role.FW,
              Tactic.ATTACKING,
              Weighting.create(0, 0, 50),
              Tactic.DEFENSIVE,
              Tactic.EUROPEAN)
          .bonus(
              Role.AM,
              Tactic.ATTACKING,
              Weighting.create(0, 0, 25),
              Tactic.DEFENSIVE,
              Tactic.EUROPEAN)
          ...
          .bonus(
              Role.DF,
              Tactic.COUNTER_ATTACK,
              Weighting.create(0, 25, 25),
              Tactic.PASSING,
              Tactic.ATTACKING)
          .bonus(
              Role.AM,
              Tactic.COUNTER_ATTACK,
              Weighting.create(0, 0, 40),
              Tactic.PASSING,
              Tactic.ATTACKING)
          .bonus(
              Role.DM,
              Tactic.COUNTER_ATTACK,
              Weighting.create(10, 0, 0),
              Tactic.PASSING,
              Tactic.ATTACKING)
          ...
          .bonus(
              Role.MF, Tactic.PASSING, Weighting.create(25, 0, 25), Tactic.LONG_BALL, Tactic.NORMAL)
          .bonus(
              Role.FW, Tactic.PASSING, Weighting.create(0, 0, 25), Tactic.LONG_BALL, Tactic.NORMAL)
          .bonus(
              Role.DM, Tactic.PASSING, Weighting.create(25, 0, 0), Tactic.LONG_BALL, Tactic.NORMAL)
          .bonus(
              Role.AM, Tactic.PASSING, Weighting.create(0, 0, 25), Tactic.LONG_BALL, Tactic.NORMAL)
          ...
          .bonus(
              Role.DF,
              Tactic.EUROPEAN,
              Weighting.create(25, 25, 0),
              Tactic.COUNTER_ATTACK,
              Tactic.DEFENSIVE)
          .bonus(
              Role.FW,
              Tactic.EUROPEAN,
              Weighting.create(0, 25, 0),
              Tactic.COUNTER_ATTACK,
              Tactic.DEFENSIVE)
          .bonus(
              Role.AM,
              Tactic.EUROPEAN,
              Weighting.create(0, 10, 0),
              Tactic.COUNTER_ATTACK,
              Tactic.DEFENSIVE)
          .bonus(
              Role.DM,
