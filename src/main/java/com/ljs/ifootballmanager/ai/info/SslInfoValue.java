...
public final class SslInfoValue implements InfoValue {
  ...
  public Double get(Player p) {
    ...
    Double mult =
        930.0 + 25 * p.getSkill(p.getSecondarySkill()) + 15 * p.getSkill(p.getTertiarySkill());
